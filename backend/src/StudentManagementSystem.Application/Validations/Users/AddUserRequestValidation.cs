    ...
    public class AddUserRequestValidation : AbstractValidator<AddUserRequestDto>
    {
        public AddUserRequestValidation()
        {
            ...
            RuleFor(x => x.Gender)
                ...
                .Must(gender => Enum.IsDefined(typeof(GenderType), gender)).WithMessage("Invalid Gender");
            ...
            RuleFor(x => x.Location)
                ...
                .Must(role => Enum.IsDefined(typeof(LocationType), role)).WithMessage("Invalid Location");
        }
